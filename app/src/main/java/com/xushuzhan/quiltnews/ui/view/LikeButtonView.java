...
public class LikeButtonView extends FrameLayout implements View.OnClickListener {
    public static final String TAG = "LikeButtonViewTAG";
    public interface OnLikeButtonClickedListenner{
        void onLikeButtonClick(boolean isChecked);
    }
    OnLikeButtonClickedListenner listener;
    public void setOnLikeButtonClickedListenner(OnLikeButtonClickedListenner listener){
    ...
    public void onClick(View v) {
       ...
       if (isChecked) {
        ...
        listener.onLikeButtonClick(isChecked);
    }
